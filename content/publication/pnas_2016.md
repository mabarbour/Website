...
abstract_short = "We discovered that heritable trait variation resulted in different host-plant genotypes supporting unique compositions of multitrophic interactions. This genetic specificity increased food-web complexity under simulated increases in host-plant genetic diversity. Given that food-web complexity is thought to buffer ecological communities from disturbances, this research puts us in a position to predict how processes that alter genetic variation within a population (e.g. natural selection, genetic drift, gene flow, and mutation) will affect the structure and robustness of food webs to environmental change."
